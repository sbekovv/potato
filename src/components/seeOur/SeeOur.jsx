            ...
            <div className="container">
                <div className="seeOur-container">
                    ...
                    <div className="seeOur-text">
                        <h1>See our review</h1>
                        <img src={Star} />
                        <hr/>
                        <p>Potatoes were introduced to Europe from the Americas by the Spanish in the second half of the
                            16th century. Today they are a staple food in many parts of the world and an integral part of
                            much of the world's food supply. As of 2014, potatoes were the world's fourth-largest food
                            crop.</p>
                    </div>
                </div>
            </div>
